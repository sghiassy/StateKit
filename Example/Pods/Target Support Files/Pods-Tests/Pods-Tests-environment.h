...
// StateKit
#define COCOAPODS_POD_AVAILABLE_StateKit
#define COCOAPODS_VERSION_MAJOR_StateKit 0
#define COCOAPODS_VERSION_MINOR_StateKit 1
#define COCOAPODS_VERSION_PATCH_StateKit 0
